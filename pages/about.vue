  ...
  <div class="text-example">
    ...
    >
      ...
      >
        ...
        <p class="xl:text-[18px] mt-1 md:mt-0 md:w-[500px] text-sm">
          ...
          was born out of a deep commitment to tackling one of the most pressing
          health challenges of our time—NAFLD (Non-Alcoholic Fatty Liver
        ...
        >
          <img
            ...
            class="w-[64px] rounded-full p-[2px] border-white border"
            alt=""
          />
          <div>
    ...
    <section>
      ...
      >
        ...
        <img
          src="/about/capsule.png"
          class="absolute w-[100px] hidden lg:block animate-bounce md:w-[124px]"
          alt="capsule"
        />
        <div
          class="w-full text-end md:p-4 mt-6 lg:w-[500px] xl:w-[650px] md:mt-0"
        >
          <div
            class="p-1 md:p-2 rounded-lg border-[#2078A7] lg:h-[304px] xl:h-[300px] border shadow-lg"
          >
      ...
      items: [
        {
          ...
          icon: "https://path-to-your-icon.com/icon1.svg",
          highlight: false,
        },
        {
          ...
          description:
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.",
          icon: "https://path-to-your-icon.com/icon2.svg",
          highlight: true, // Highlight the card
        },
        {
          title: "Diabetes Testing",
          description:
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.",
          icon: "https://path-to-your-icon.com/icon3.svg",
          highlight: false,
        },
        {
          ...
          description:
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.",
          icon: "https://path-to-your-icon.com/icon4.svg",
          highlight: false,
        },
        {
          ...
          description:
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.",
          icon: "https://path-to-your-icon.com/icon5.svg",
          highlight: false,
        },
        {
          title: "Heart Disease",
          description:
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.",
          icon: "https://path-to-your-icon.com/icon6.svg",
          highlight: false,
        },
      ],
      cards: [
